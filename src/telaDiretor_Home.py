...
#======================criando a janela======================
telaDir_Home = ctk.CTk(fg_color='white')

#======================configurando a janela principal======================
telaDir_Home.title('Diretor - Home')
telaDir_Home.geometry('1260x960')
telaDir_Home.resizable(False, False)
telaDir_Home._set_appearance_mode('dark')

#======================funcao======================
#funcao para iniciar a janela centralizada
def centralizarTela(telaDir_Home):
    telaDir_Home.update_idletasks()
    width = telaDir_Home.winfo_width()
    height = telaDir_Home.winfo_height()
    screen_width = telaDir_Home.winfo_screenwidth()
    screen_height = telaDir_Home.winfo_screenheight()
    x = (screen_width // 2) - (width // 2)
    y = (screen_height // 2) - (height // 2)
    telaDir_Home.geometry('{}x{}+{}+{}'.format(width, height, x, y))

#funcao para centralizar a janela
centralizarTela(telaDir_Home)
...
lblPlanoDFundo = ctk.CTkLabel(telaDir_Home, image=imgPlanoDFundo, text='')
lblPlanoDFundo.place(x=0, y=0)

#======================configurando frames======================
#======================configurando frame de fundo do menu======================
frmFundoMenu = ctk.CTkFrame(telaDir_Home, width=1260, height=120, corner_radius=0,
    fg_color='white')
...
frmFundoMain = ctk.CTkFrame(telaDir_Home, width=960, height=500, corner_radius=0,
    fg_color='white')
...
frmFundoMenuLateral = tk.Frame(telaDir_Home, width=100, bg="#069E6E")
