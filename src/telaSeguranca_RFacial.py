...
#======================criando a janela======================
telaSeg_RFacial = ctk.CTk(fg_color='#f1f1f1')

#======================configurando a janela principal======================
telaSeg_RFacial.title('Segurança - Reconhecimento Facial')
telaSeg_RFacial.geometry('1260x760')
telaSeg_RFacial.resizable(False, False)
telaSeg_RFacial._set_appearance_mode('dark')

#======================funcao======================
#funcao para iniciar a janela centralizada
def centralizarTela(telaSeg_RFacial):
    telaSeg_RFacial.update_idletasks()
    width = telaSeg_RFacial.winfo_width()
    height = telaSeg_RFacial.winfo_height()
    screen_width = telaSeg_RFacial.winfo_screenwidth()
    screen_height = telaSeg_RFacial.winfo_screenheight()
    x = (screen_width // 2) - (width // 2)
    y = (screen_height // 2) - (height // 2)
    telaSeg_RFacial.geometry('{}x{}+{}+{}'.format(width, height, x, y))

#funcao para centralizar a janela
centralizarTela(telaSeg_RFacial)
...
lblPlanoDFundo = ctk.CTkLabel(telaSeg_RFacial, image=imgPlanoDFundo, text='')
lblPlanoDFundo.place(x=0, y=0 )

#======================configurando frames======================
#======================configurando frame de fundo do menu======================
frmFundoMenu = ctk.CTkFrame(telaSeg_RFacial, width=1260, height=120, corner_radius=0,
    fg_color='white')
...
frmFundoMain = ctk.CTkFrame(telaSeg_RFacial, width=1060, height=740, corner_radius=0,
    fg_color='white')
...
frmFundoMenuLateral = tk.Frame(telaSeg_RFacial, width=100, bg="#069E6E")
